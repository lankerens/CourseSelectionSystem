...
<div class="container" style="background-color: pink ; width: 100%" >
    <ul class="nav nav-pills" >
        ...
        <li class="active"><a href="#">管理个人信息</a></li>
...
<div class="container">
    <h3 style="text-align: left">管理个人信息</h3>
</div>
<br><br>

<!--  学号   姓名  身份证  性别  密码   年龄   班级    专业 -->
...
<div class="container">
    <table border="1" cellpadding="1" cellspacing="1" width="70%" style="text-align: center">
        ...
        <tr>
            <td>学号</td>
            <td>${getStuInfo.sid}</td>
            <td>学生信息唯一标识</td>
        </tr>
        <tr>
            <td>姓名</td>
            <td>${getStuInfo.sname}</td>
            <td>不可修改</td>
        </tr>
        <tr>
            <td>身份证</td>
            <td>${getStuInfo.sidcard}</td>
            <td>不可修改</td>
        </tr>
        <tr>
            <td>性别</td>
            <td>${getStuInfo.ssex}</td>
            <td>不可修改</td>
        </tr>
        <tr>
            <td>密码</td>
                    ...
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/UpdateStudPassword" method="post" id="abc">
                                <div class="modal-body">
                                        <input type="hidden" name="sid" value="${getStuInfo.sid}">
        ...
        <tr>
            <td>年龄</td>
            <td>${getStuInfo.sage}</td>
            <td>不可修改</td>
        </tr>
        <tr>
            <td>班级</td>
            <td>${getStuInfo.classr}</td>
            <td>不可修改</td>
        </tr>
        <tr>
            <td>专业</td>
            <td>${getStuInfo.profession}</td>
            <td>不可修改</td>
        </tr>
        <tr>
            <td>学院</td>
            <td>${getStuInfo.college}</td>
            <td>不可修改</td>
        </tr>
    </table>
</div>
